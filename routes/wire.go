...
// randHex is the nonce source both DeviceChallenge and RecoveryRoutes' own
// request handler draw from — ported from the gateway's auth_handlers.go,
// which kept it beside the shared middleware rather than either individual
